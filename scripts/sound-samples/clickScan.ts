...
if (process.argv[1] && pathToFileURL(resolve(process.argv[1])).href === import.meta.url) {
  ...
  try {
    ...
    SCENES.push(
      ...
      // This scene is where they are, on the default tuning, which is the
      // tuning anybody actually hears.
      ...
      // the choral banks up, a promotion moves a voice that is carrying much
      // more of the mix, and it moves it against a bed rather than under a
      // flourish.
      {
        ...sweepScene(
          "sweeps-promotion-churn-spencer",
          "presence",
          SCAN_SECONDS,
          { handoverMs: SWEEP_PROMOTION_HANDOVER_MS },
        ),
