...
export interface SceneConfig {
  ...
  port?: string;
  // Default runtime duration in milliseconds for loop-based scenes.
  durationMs?: number;
  // Optional default base URL for scenes that compose page paths at runtime.
  baseUrl?: string;
  // Optional URL printed for the human browser when it differs from actor URLs.
  hostUrl?: string;
...
export interface SceneContext {
  ...
  port?: string;
  // Actor personas generated by the runner.
  personas: ActorPersona[];
  // Runtime options parsed by the runner.
