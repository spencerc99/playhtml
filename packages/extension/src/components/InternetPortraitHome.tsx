      ...
      <main className="portrait-home__main">
                ...
                <div key={c.type} className="collector-pill">
                  <div className="collector-pill__name-row">
                    <span aria-hidden className="collector-pill__icon">
                      {c.type === "cursor" && (
                        <svg width="14" height="14" viewBox="0 0 32 32" fill="#3d3833" xmlns="http://www.w3.org/2000/svg">
                      ...
                      {c.type === "navigation" && (
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <rect x="5" y="10" width="14" height="7" fill="#efe9df" stroke="#efe9df" />
                        </svg>
                      )}
                      {c.type === "viewport" && (
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span className={`collector-pill__state collector-pill__state--${c.enabled ? "on" : "off"}`}>
                    {c.enabled ? "On" : "Off"}
                  </span>
                </div>
              ))}
        ...
        <section style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          ...
          <p className="preview-hint">
            A preview of cursor movement animates above. Click to view your full portrait.
          </p>
        </section>
      </main>
