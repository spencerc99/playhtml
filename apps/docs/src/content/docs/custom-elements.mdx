...
} from "@/components/playground/recipes/mirror-basics";
import {
  sharedCounterRecipe,
  sharedGuestbookRecipe,
} from "@/components/playground/recipes/shared-state-basics";
...
<div class="ph-demo-slot" data-label="LIVE DEMO — can-mirror: growing list">
  <RecipeExample
    recipe={growingListMirrorRecipe}
    compact
    frameHeight="25rem"
    client:load
  />
