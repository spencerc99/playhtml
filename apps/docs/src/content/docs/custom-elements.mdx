...
import { DocsCounter } from "@/components/react/capability-demos/DocsCounter";
...
<div id="play-counter" class="ph-canplay-inline" data-label="can-play · counter">
  <div class="ph-canplay-inline__head">
    <span class="ph-canplay-inline__kicker">CAN-PLAY · counter</span>
    <p class="ph-canplay-inline__caption">
      Click to add one. The count is shared — everyone reading this page bumps the same number.
    </p>
  </div>
  <DocsCounter client:only="react" />
</div>
...
<div id="play-toggle" class="ph-canplay-inline" data-label="can-play · toggle">
  <div class="ph-canplay-inline__head">
    <span class="ph-canplay-inline__kicker">CAN-PLAY · toggle</span>
    <p class="ph-canplay-inline__caption">
