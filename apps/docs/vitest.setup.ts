// ABOUTME: Provides browser API shims for docs integration tests in jsdom.
// ABOUTME: Keeps playhtml initialization deterministic without real network providers.
